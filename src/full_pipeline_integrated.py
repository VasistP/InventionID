...
- Return JSON only, no markdown fences, no other text."""
    ...
    def _refine_invention(self, invention, suggestions, document_text):
...
Return improved JSON with the same structure. Focus on:
    ...
    def run(self, document_text):
        ...
        for i in range(self.max_iterations):
            ...
            if invention is None:
                ...
                invention = self._extract_invention(document_text)
            ...
            invention = self._refine_invention(invention, suggestions_str, document_text)
